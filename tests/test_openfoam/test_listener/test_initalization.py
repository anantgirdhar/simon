...
def test_raises_value_error_when_compress_every_is_smaller_than_keep_every(
...
def test_raises_value_error_when_compress_every_is_equal_to_keep_every(
    keep_every: Decimal,
...
def test_initializes_successfully_when_keep_every_divides_compress_every(
    keep_every: Decimal, compress_every: Decimal
) -> None:
...
def test_raises_value_error_when_keep_every_does_not_divide_compress_every(
    keep_every: Decimal, compress_every: Decimal
) -> None:
    with pytest.raises(ValueError):
        OFListener(
